...
function restoreTheme() {
  ...
  if (localStorage.getItem("themeName")) {
    let previousTheme = localStorage.getItem("themeName");
...
function restoreName() {
  // Your code here
  let field = document.getElementById("display-name");

  if (sessionStorage.getItem("displayName")) {
    field.value = sessionStorage.getItem("displayName");
  }

  field.addEventListener("change", () => {
    sessionStorage.setItem("displayName", field.value);
  });
}
